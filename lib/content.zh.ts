        ...
        items: [
          {
            ...
            domain: "tencent.com",
            bullets: [
              "围绕微信智能助手相关世界杯节点宣发，参与 AIGC 视频项目，推进脚本、生图、生视频、音色配音与剪辑协同，横向试用多类工具及模型，沉淀可复用的视频生产工作流",
              "基于 AIGC 视频生产中的重复试错、素材分散和协作成本等痛点，完成 AI 视频协作工作台 PRD 设计，并通过 Vibe Coding 快速搭建可交互 MVP，验证核心生产流程闭环",
              "参与 WeStore 商品开发与推广，跟进 brief、比稿、样品及供应商沟通；设计虚拟试衣小程序，拆解用户路径与功能规划，完成可交互原型搭建，跑通优惠券领取与小店跳转等链路",
              "围绕小微音色招募项目，承担品牌纪录片策划与拍摄统筹，完成主题策划、脚本设计、采访提纲、拍摄协调与素材整合，支持声音人格与招募故事表达",
            ],
          },
          {
            date: "2026年1月 – 4月",
